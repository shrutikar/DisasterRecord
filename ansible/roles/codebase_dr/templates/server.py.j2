...
def campaign(campaignid):
    ...
    if campaignid=='Dayton':
        ...
        campaign_esname=["dayton"]
        campaign_date_start=["08/01/2017"]
        campaign_date_end=["12/29/2017"]
        campaign_default_zoom=[15]
    elif campaignid=='IRMA':
        #centroid=[-81.524596,28.391981]
        centroid=[-81.069233,26.856820]
        campaign_BB=[24.165,-83.4978,27.7287,-79.7487]
        drone_data=dronedata.getData("irma")
        campaign_esname=["irma"]
        campaign_date_start=["08/01/2017"]
        campaign_date_end=["12/29/2017"]
        campaign_default_zoom=[7]
    elif campaignid=='Florance':
        centroid=[-77.903326,34.786072]
        campaign_BB=[33.8117,-78.7625,34.9456,-77.2299]
        drone_data=dronedata.getData("florance")
        campaign_esname=["florance"]
        campaign_date_start=["08/01/2017"]
        campaign_date_end=["12/29/2017"]
        campaign_default_zoom=[7]
